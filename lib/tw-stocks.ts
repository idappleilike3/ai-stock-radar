...
// ============ 黑名單（強制排除，2026-06-28 蝦董親定）============
// 這些股票從所有掃描 / 推薦 / 異常區塊都完全排除
// 原因：表現異常 / 個股事件 / 題材轉弱 / 流動性疑慮 等
// 加新檔只需 push 進去即可，全站自動生效
export const EXCLUDED_STOCKS: string[] = [
  '6669', // 緯穎 — 5 日 200.3% 異常噴出，不適合短線狙擊
  '2379', // 瑞昱 — 5 日 45.6% 異常噴出，不適合短線狙擊
];
